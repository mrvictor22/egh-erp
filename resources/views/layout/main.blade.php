        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              ?>
              @if($index_permission_active)
              <li hidden><a href="#produccion" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>{{trans('file.Produccion')}}</span><span></a>
                <ul id="produccion" class="collapse list-unstyled ">
                  <li id="lecherecibida-menu"><a href="{{route('lecherecibida.index')}}">{{trans('file.Leche Recibida')}}</a></li>
                  ...
                  ?>
                  @if($add_permission_active)
                  <li hidden id="lineaproduccion-menu"><a href="{{route('lineaproduccion.index')}}">{{trans('file.Linea de Produccion')}}</a></li>
                  @endif
                  <li id="lecherecibida-list-menu1"><a href="{{route('procesos.index')}}">{{trans('file.Procesos')}}</a></li>
                  <li id="lecherecibida-list-menu2"><a href="{{route('reprocesos.index')}}">{{trans('file.Reprocesos')}}</a></li>
                  <!-- <li id="lecherecibida-list-menu3"><a href="{{route('quotations.index')}}">{{trans('file.Reportes')}}</a></li> -->
                </ul>
              </li>
              @endif
              ...
              <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document-remove"></i><span>{{trans('file.Reports')}}</span></a>
                <ul id="report" class="collapse list-unstyled ">
                  ...
                  <li hidden id="product-prod-proc">
                    {!! Form::open(['route' => 'report.product_prod_cost', 'method' => 'post', 'id' => 'product-report-form-proc']) !!}
                    <input type="hidden" name="start_date" value="1988-04-18" />
                    <input type="hidden" name="end_date" value="{{date('Y-m-d')}}" />
                    <input type="hidden" name="warehouse_id" value="0" />
                    <a id="product-prod-proc-link" href="">{{trans('file.Informe prod proc')}}</a>
                    {!! Form::close() !!}
                  </li>
                  @endif
                </ul>
    ...
    <div class="page">
      ...
      <footer hidden class="main-footer">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; {{$general_setting->site_title}} | {{trans('file.Developed')}} {{trans('file.By')}} <a href="" class="external">VC</a></p>
            </div>
          </div>
        </div>
      </footer>
