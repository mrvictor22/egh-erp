...
<html>
  ...
  <body onload="myFunction()">
        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <!-- Nuevo Menu Modulo de Produccion -->
              <?php 
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li hidden><a href="#produccion" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span><?php echo e(trans('file.Produccion')); ?></span><span></a>
                <ul id="produccion" class="collapse list-unstyled ">
                  <li id="lecherecibida-menu"><a href="<?php echo e(route('lecherecibida.index')); ?>"><?php echo e(trans('file.Leche Recibida')); ?></a></li>
                  ...
                  ?>
                  <?php if($add_permission_active): ?>
                  <li hidden id="lineaproduccion-menu"><a href="<?php echo e(route('lineaproduccion.index')); ?>"><?php echo e(trans('file.Linea de Produccion')); ?></a></li>
                  <?php endif; ?>
                  <li id="lecherecibida-list-menu1"><a href="<?php echo e(route('procesos.index')); ?>"><?php echo e(trans('file.Procesos')); ?></a></li>
                  <li id="lecherecibida-list-menu2"><a href="<?php echo e(route('reprocesos.index')); ?>"><?php echo e(trans('file.Reprocesos')); ?></a></li>
                  <!-- <li id="lecherecibida-list-menu3"><a href="<?php echo e(route('quotations.index')); ?>"><?php echo e(trans('file.Reportes')); ?></a></li> -->
                </ul>
              </li>
              <?php endif; ?>
              ...
              <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document-remove"></i><span><?php echo e(trans('file.Reports')); ?></span></a>
                <ul id="report" class="collapse list-unstyled ">
                  ...
                  <?php endif; ?>
                  <?php if($product_report_active): ?>
                  <li hidden id="product-prod-proc">
                    <?php echo Form::open(['route' => 'report.product_prod_cost', 'method' => 'post', 'id' => 'product-report-form-proc']); ?>

                    <input type="hidden" name="start_date" value="1988-04-18" />
                    <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                    <input type="hidden" name="warehouse_id" value="0" />
                    <a id="product-prod-proc-link" href=""><?php echo e(trans('file.Informe prod proc')); ?></a>
                    <?php echo Form::close(); ?>
    ...
    <div class="page">
      ...
      <footer hidden class="main-footer">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; <?php echo e($general_setting->site_title); ?> | <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="" class="external">VC</a></p>
            </div>
          </div>
        </div>
      </footer>
    ...
    <script type="text/javascript">
      ...
      $("a#product-prod-proc-link").click(function(e){
        e.preventDefault();
        $("#product-report-form-proc").submit();
      });
